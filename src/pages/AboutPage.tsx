          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  <strong className="text-[#970048]">Mayara Rodrigues</strong> é a mente criativa e apaixonada por trás de cada peça que leva o nome da Use Acessórios. Formada em Engenharia Ambiental e Marketing Digital, ela une conhecimento técnico, visão estratégica e um olhar sensível para transformar jóias em verdadeiras obras de arte.
                </p>
                <p>
                  Desde pequena, Mayara sempre se encantou com o brilho, o detalhe e a história que cada joia pode carregar. Para ela, não se trata apenas de acessórios, mas de expressões de personalidade, lembranças afetivas e símbolos de momentos especiais.
                </p>
                <p>
                  "Acredito que toda mulher merece se sentir especial e confiante. Os acessórios certos podem transformar não apenas um look,
                  mas também como nos sentimos sobre nós mesmas", diz Mayara.
                </p>
                <p>
